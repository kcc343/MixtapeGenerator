    ...
    <br />
        <div class="container-fluid" style="background-color:#1F2833">
            ...
            <p class="h5" style="color:lightgrey">
                ...
                <br /><br />
                To use the application, the user must input a song name and artist name, that are used to retrieve data 
                from the Spotify API.  The user must confirm the song choice from 
