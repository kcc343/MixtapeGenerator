...
<%--@* Section to display after user confirms the song from the list of results:
    ...
    <div class="container-fluid" style="background-color:#DBE4EE" >
        ...
        <asp:RadioButtonList ID="RadioButtonList1" runat="server" Font-Size="Smaller" Font-Bold="false">
            <asp:ListItem Value="0" Text=" Choice -" Selected="True"></asp:ListItem> <%--Selected attribute--%>
            <asp:ListItem Value="1" Text=" Choice -"></asp:ListItem>
            <asp:ListItem Value="2" Text=" Choice -"></asp:ListItem>
            <asp:ListItem Value="3" Text=" Choice -"></asp:ListItem>
            <asp:ListItem Value="4" Text=" Choice -"></asp:ListItem>
        </asp:RadioButtonList>
